...
function svgDensity(metadata, width, height) {
    ...
    var currentDensity = (_a = metadata.density) !== null && _a !== void 0 ? _a : 72;
    return Math.min(Math.max(1, currentDensity, (currentDensity * width) / metadata.width, (currentDensity * height) / metadata.height), 100000);
}
exports.svgDensity = svgDensity;
